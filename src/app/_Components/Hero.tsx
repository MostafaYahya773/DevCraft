export default function Hero() {
  return (
    <div className="relative w-full h-screen flex flex-col md:flex-row items-center">
      <div className="md:w-1/2 h-1/2 md:h-full flex flex-col justify-center items-start px-8 md:px-16 bg-gradient-to-br from-dark via-dark/90 to-primary/60 text-white">
        ...
        <p className="text-base md:text-lg font-body mb-8 opacity-90">
          ...
          and <span className="font-semibold">Web Platforms</span> that help
          startups and businesses scale faster and smarter.
        </p>
        <div className="flex gap-4">
          <button className="px-6 py-3 bg-accent text-dark font-semibold rounded-lg shadow-lg bg-primary transition">
            Get Started
          </button>
        </div>
      </div>
